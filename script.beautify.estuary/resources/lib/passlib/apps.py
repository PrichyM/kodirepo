...
from resources.lib.passlib.context import LazyCryptContext
...
def _iter_ldap_crypt_schemes():
    from resources.lib.passlib.utils import unix_crypt_schemes
...
##    "helper which iterates over supported std ldap schemes"
##    from resources.lib.passlib.handlers.ldap_digests import get_host_ldap_crypt_schemes
