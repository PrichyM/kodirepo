"""resources.lib.passlib.handlers.scram - hash for SCRAM credential storage"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from resources.lib.passlib.utils import consteq, saslprep, to_native_str, splitcomma
from resources.lib.passlib.utils.binary import ab64_decode, ab64_encode
from resources.lib.passlib.utils.compat import bascii_to_str, iteritems, u, native_string_types
from resources.lib.passlib.crypto.digest import pbkdf2_hmac, norm_hash_name
...
class scram(uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    ...
    def extract_digest_info(cls, hash, alg):
        ...
        :arg alg:
            ...
            This value is run through :func:`~resources.lib.passlib.crypto.digest.norm_hash_name`,
...
##    against SCRAM protocol examples. not officially part of resources.lib.passlib.
##
