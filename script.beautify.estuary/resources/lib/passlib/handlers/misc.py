"""resources.lib.passlib.handlers.misc - misc generic handlers
"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from resources.lib.passlib.utils import to_native_str, str_consteq
from resources.lib.passlib.utils.compat import unicode, u, unicode_or_bytes_types
...
class unix_disabled(uh.ifc.DisabledHash, uh.MinimalHandler):
    ...
    no matter the hash string. The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash`
...
class plaintext(uh.MinimalHandler):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash`, :meth:`~resources.lib.passlib.ifc.PasswordHash.genhash`, and :meth:`~resources.lib.passlib.ifc.PasswordHash.verify` methods all require the
