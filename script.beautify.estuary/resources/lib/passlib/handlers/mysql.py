"""resources.lib.passlib.handlers.mysql
...
MySQL 3.2.3 / OLD_PASSWORD()
    ...
    See :mod:`resources.lib.passlib.handlers.mysql_41` for the new algorithm was put in place in version 4.1
...
from resources.lib.passlib.utils.compat import bascii_to_str, unicode, u, \
