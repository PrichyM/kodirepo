"""resources.lib.passlib.handlers.nthash - Microsoft Windows -related hashes"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from resources.lib.passlib.utils import to_unicode, right_pad_string
...
class lmhash(uh.TruncateMixin, uh.HasEncodingContext, uh.StaticHandler):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.using` method accepts a single
    optional keyword:
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash` and :meth:`~resources.lib.passlib.ifc.PasswordHash.verify` methods accept a single
    optional keyword:
...
class nthash(uh.StaticHandler):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash` and :meth:`~resources.lib.passlib.ifc.PasswordHash.genconfig` methods accept no optional keywords.
...
class msdcc(uh.HasUserContext, uh.StaticHandler):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash`, :meth:`~resources.lib.passlib.ifc.PasswordHash.genhash`, and :meth:`~resources.lib.passlib.ifc.PasswordHash.verify` methods
