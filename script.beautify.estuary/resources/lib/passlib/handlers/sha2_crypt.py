"""resources.lib.passlib.handlers.sha2_crypt - SHA256-Crypt / SHA512-Crypt"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from resources.lib.passlib.utils import safe_crypt, test_crypt, \
                          repeat_string, to_unicode
from resources.lib.passlib.utils.binary import h64
from resources.lib.passlib.utils.compat import byte_elem_value, u, \
...
def _raw_sha2_crypt(pwd, salt, rounds, use_512=False):
    ...
    #       others from being DOSed in this way (see resources.lib.passlib.exc.PasswordSizeError
    #       for details).
