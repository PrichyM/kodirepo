"""resources.lib.passlib.handlers.scrypt -- scrypt password hash"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from resources.lib.passlib.crypto import scrypt as _scrypt
from resources.lib.passlib.utils import h64, to_bytes
from resources.lib.passlib.utils.binary import h64, b64s_decode, b64s_encode
from resources.lib.passlib.utils.compat import u, bascii_to_str, suppress_cause
...
class scrypt(uh.ParallelismMixin, uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.HasManyIdents,
    ...
    .. todo::
        ...
        for ``block_size`` or ``parallelism`` via a :class:`~resources.lib.passlib.context.CryptContext`
        configuration.
    """
    ...
    #       which actually switches the backend that 'resources.lib.passlib.crypto.scrypt.scrypt()' uses.
    #===================================================================
