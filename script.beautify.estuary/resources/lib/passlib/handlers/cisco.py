"""
resources.lib.passlib.handlers.cisco -- Cisco password hashes
"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from resources.lib.passlib.utils import right_pad_string, to_unicode, repeat_string, to_bytes
from resources.lib.passlib.utils.binary import h64
from resources.lib.passlib.utils.compat import unicode, u, join_byte_values, \
...
class cisco_pix(uh.HasUserContext, uh.StaticHandler):
    ...
    will result in a :exc:`~resources.lib.passlib.exc.PasswordSizeError` if passed to :meth:`~cisco_pix.hash`,
    and be silently rejected if passed to :meth:`~cisco_pix.verify`.

    The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash`,
    :meth:`~resources.lib.passlib.ifc.PasswordHash.genhash`, and
    :meth:`~resources.lib.passlib.ifc.PasswordHash.verify` methods
...
class cisco_asa(cisco_pix):
    ...
    will result in a :exc:`~resources.lib.passlib.exc.PasswordSizeError` if passed to :meth:`~cisco_asa.hash`,
