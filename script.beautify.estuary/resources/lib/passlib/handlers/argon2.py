"""resources.lib.passlib.handlers.argon2 -- argon2 password hash wrapper
...
from resources.lib.passlib.crypto.digest import MAX_UINT32
from resources.lib.passlib.utils import classproperty, to_bytes, render_bytes
from resources.lib.passlib.utils.binary import b64s_encode, b64s_decode
from resources.lib.passlib.utils.compat import u, unicode, bascii_to_str, uascii_to_str, PY2
...
class argon2(_NoBackend, _Argon2Common):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.replace` method accepts the following optional keywords:
