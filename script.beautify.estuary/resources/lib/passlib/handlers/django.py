"""resources.lib.passlib.handlers.django- Django password hash support"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from resources.lib.passlib.handlers.bcrypt import _wrapped_bcrypt
from resources.lib.passlib.hash import argon2, bcrypt, pbkdf2_sha1, pbkdf2_sha256
from resources.lib.passlib.utils import to_unicode, rng, getrandstr
from resources.lib.passlib.utils.binary import BASE64_CHARS
from resources.lib.passlib.utils.compat import str_to_uascii, uascii_to_str, unicode, u
...
def _import_des_crypt():
    ...
    if des_crypt is None:
        from resources.lib.passlib.hash import des_crypt
    return des_crypt
...
class django_salted_sha1(DjangoSaltedHash):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash` and :meth:`~resources.lib.passlib.ifc.PasswordHash.genconfig` methods accept the following optional keywords:
...
django_bcrypt = uh.PrefixWrapper("django_bcrypt", bcrypt,
    ...
    See :doc:`/lib/resources.lib.passlib.hash.bcrypt` for more details,
...
class django_bcrypt_sha256(_wrapped_bcrypt):
    ...
    see :doc:`bcrypt </lib/resources.lib.passlib.hash.bcrypt>` for more details.
...
django_argon2 = uh.PrefixWrapper(
    ...
    See :doc:`argon2 </lib/resources.lib.passlib.hash.argon2>` for more details,
    the usage and behavior is identical.
