...
# site
# pkg
from resources.lib.passlib.handlers.misc import plaintext
from resources.lib.passlib.utils import unix_crypt_schemes, to_unicode
from resources.lib.passlib.utils.compat import uascii_to_str, unicode, u
...
class ldap_md5(_Base64DigestHelper):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash` and :meth:`~resources.lib.passlib.ifc.PasswordHash.genconfig` methods have no optional keywords.
    """
    name = "ldap_md5"
    ident = u("{MD5}")
    _hash_func = md5
...
class ldap_plaintext(plaintext):
    ...
    This class acts much like the generic :class:`!resources.lib.passlib.hash.plaintext` handler,
...
##        from resources.lib.passlib.hosts import host_context
