"""resources.lib.passlib.bcrypt -- implementation of OpenBSD's BCrypt algorithm.
...
from resources.lib.passlib.crypto.digest import compile_hmac
from resources.lib.passlib.exc import PasslibHashWarning, PasslibSecurityWarning, PasslibSecurityError
from resources.lib.passlib.utils import safe_crypt, repeat_string, to_bytes, parse_version, \
...
from resources.lib.passlib.utils.compat import get_unbound_method_function
from resources.lib.passlib.utils.compat import u, uascii_to_str, unicode, str_to_uascii, PY3, error_from
        ...
        def assert_lacks_8bit_bug(ident):
            ...
            if verify(secret, bug_hash):
                ...
                raise PasslibSecurityError(
                    "resources.lib.passlib.hash.bcrypt: Your installation of the %r backend is vulnerable to "
        ...
        if result is NotImplemented:
            ...
            if detect_wrap_bug(IDENT_2A):
                if backend == "os_crypt":
                    ...
                    warn("resources.lib.passlib.hash.bcrypt: Your installation of the %r backend is vulnerable to "
...
class _BuiltinBackend(_BcryptCommon):
    ...
    @classmethod
    def _load_backend_mixin(mixin_cls, name, dryrun):
        from resources.lib.passlib.utils import as_bool
        ...
        from resources.lib.passlib.crypto._blowfish import raw_bcrypt as _builtin_bcrypt
        return mixin_cls._finalize_backend_mixin(name, dryrun)
...
class bcrypt(_NoBackend, _BcryptCommon):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.using` method accepts the following optional keywords:
    ...
    :param bool truncate_error:
        ...
        Setting ``truncate_error=True`` will cause :meth:`~resources.lib.passlib.ifc.PasswordHash.hash`
        to raise a :exc:`~resources.lib.passlib.exc.PasswordTruncateError` instead.
    ...
    :param relaxed:
        ...
        and the error can be corrected, a :exc:`~resources.lib.passlib.exc.PasslibHashWarning`
...
class bcrypt_sha256(_wrapped_bcrypt):
    ...
    The :meth:`~resources.lib.passlib.ifc.PasswordHash.hash` and :meth:`~resources.lib.passlib.ifc.PasswordHash.genconfig` methods accept
