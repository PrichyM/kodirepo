"""resources.lib.passlib.registry - registry for password hash handlers"""
#=============================================================================
# imports
#=============================================================================
# core
...
# pkg
from resources.lib.passlib import exc
from resources.lib.passlib.exc import ExpectedTypeError, PasslibWarning
from resources.lib.passlib.ifc import PasswordHash
from resources.lib.passlib.utils import (
    is_crypt_handler, has_crypt as os_crypt_present,
    unix_crypt_schemes as os_crypt_schemes,
)
from resources.lib.passlib.utils.compat import unicode_or_str
from resources.lib.passlib.utils.decor import memoize_single_value
# local
__all__ = [
...
#=============================================================================
# proxy object used in place of 'resources.lib.passlib.hash' module
#=============================================================================
class _PasslibRegistryProxy(object):
    """proxy module resources.lib.passlib.hash

    this module is in fact an object which lazy-loads
    the requested password hash algorithm from wherever it has been stored.
    it acts as a thin wrapper around :func:`resources.lib.passlib.registry.get_crypt_handler`.
    """
    __name__ = "resources.lib.passlib.hash"
    __package__ = None
    ...
    def __repr__(self):
        return "<proxy module 'resources.lib.passlib.hash'>"
...
# create single instance - available publically as 'resources.lib.passlib.hash'
...
_locations = dict(
    ...
    apr_md5_crypt = "resources.lib.passlib.handlers.md5_crypt",
    argon2 = "resources.lib.passlib.handlers.argon2",
    atlassian_pbkdf2_sha1 = "resources.lib.passlib.handlers.pbkdf2",
    bcrypt = "resources.lib.passlib.handlers.bcrypt",
    bcrypt_sha256 = "resources.lib.passlib.handlers.bcrypt",
    bigcrypt = "resources.lib.passlib.handlers.des_crypt",
    bsd_nthash = "resources.lib.passlib.handlers.windows",
    bsdi_crypt = "resources.lib.passlib.handlers.des_crypt",
    cisco_pix = "resources.lib.passlib.handlers.cisco",
    cisco_asa = "resources.lib.passlib.handlers.cisco",
    cisco_type7 = "resources.lib.passlib.handlers.cisco",
    cta_pbkdf2_sha1 = "resources.lib.passlib.handlers.pbkdf2",
    crypt16 = "resources.lib.passlib.handlers.des_crypt",
    des_crypt = "resources.lib.passlib.handlers.des_crypt",
    django_argon2 = "resources.lib.passlib.handlers.django",
    django_bcrypt = "resources.lib.passlib.handlers.django",
    django_bcrypt_sha256 = "resources.lib.passlib.handlers.django",
    django_pbkdf2_sha256 = "resources.lib.passlib.handlers.django",
    django_pbkdf2_sha1 = "resources.lib.passlib.handlers.django",
    django_salted_sha1 = "resources.lib.passlib.handlers.django",
    django_salted_md5 = "resources.lib.passlib.handlers.django",
    django_des_crypt = "resources.lib.passlib.handlers.django",
    django_disabled = "resources.lib.passlib.handlers.django",
    dlitz_pbkdf2_sha1 = "resources.lib.passlib.handlers.pbkdf2",
    fshp = "resources.lib.passlib.handlers.fshp",
    grub_pbkdf2_sha512 = "resources.lib.passlib.handlers.pbkdf2",
    hex_md4 = "resources.lib.passlib.handlers.digests",
    hex_md5 = "resources.lib.passlib.handlers.digests",
    hex_sha1 = "resources.lib.passlib.handlers.digests",
    hex_sha256 = "resources.lib.passlib.handlers.digests",
    hex_sha512 = "resources.lib.passlib.handlers.digests",
    htdigest = "resources.lib.passlib.handlers.digests",
    ldap_plaintext = "resources.lib.passlib.handlers.ldap_digests",
    ldap_md5 = "resources.lib.passlib.handlers.ldap_digests",
    ldap_sha1 = "resources.lib.passlib.handlers.ldap_digests",
    ldap_hex_md5 = "resources.lib.passlib.handlers.roundup",
    ldap_hex_sha1 = "resources.lib.passlib.handlers.roundup",
    ldap_salted_md5 = "resources.lib.passlib.handlers.ldap_digests",
    ldap_salted_sha1 = "resources.lib.passlib.handlers.ldap_digests",
    ldap_salted_sha256 = "resources.lib.passlib.handlers.ldap_digests",
    ldap_salted_sha512 = "resources.lib.passlib.handlers.ldap_digests",
    ldap_des_crypt = "resources.lib.passlib.handlers.ldap_digests",
    ldap_bsdi_crypt = "resources.lib.passlib.handlers.ldap_digests",
    ldap_md5_crypt = "resources.lib.passlib.handlers.ldap_digests",
    ldap_bcrypt = "resources.lib.passlib.handlers.ldap_digests",
    ldap_sha1_crypt = "resources.lib.passlib.handlers.ldap_digests",
    ldap_sha256_crypt = "resources.lib.passlib.handlers.ldap_digests",
    ldap_sha512_crypt = "resources.lib.passlib.handlers.ldap_digests",
    ldap_pbkdf2_sha1 = "resources.lib.passlib.handlers.pbkdf2",
    ldap_pbkdf2_sha256 = "resources.lib.passlib.handlers.pbkdf2",
    ldap_pbkdf2_sha512 = "resources.lib.passlib.handlers.pbkdf2",
    lmhash = "resources.lib.passlib.handlers.windows",
    md5_crypt = "resources.lib.passlib.handlers.md5_crypt",
    msdcc = "resources.lib.passlib.handlers.windows",
    msdcc2 = "resources.lib.passlib.handlers.windows",
    mssql2000 = "resources.lib.passlib.handlers.mssql",
    mssql2005 = "resources.lib.passlib.handlers.mssql",
    mysql323 = "resources.lib.passlib.handlers.mysql",
    mysql41 = "resources.lib.passlib.handlers.mysql",
    nthash = "resources.lib.passlib.handlers.windows",
    oracle10 = "resources.lib.passlib.handlers.oracle",
    oracle11 = "resources.lib.passlib.handlers.oracle",
    pbkdf2_sha1 = "resources.lib.passlib.handlers.pbkdf2",
    pbkdf2_sha256 = "resources.lib.passlib.handlers.pbkdf2",
    pbkdf2_sha512 = "resources.lib.passlib.handlers.pbkdf2",
    phpass = "resources.lib.passlib.handlers.phpass",
    plaintext = "resources.lib.passlib.handlers.misc",
    postgres_md5 = "resources.lib.passlib.handlers.postgres",
    roundup_plaintext = "resources.lib.passlib.handlers.roundup",
    scram = "resources.lib.passlib.handlers.scram",
    scrypt = "resources.lib.passlib.handlers.scrypt",
    sha1_crypt = "resources.lib.passlib.handlers.sha1_crypt",
    sha256_crypt = "resources.lib.passlib.handlers.sha2_crypt",
    sha512_crypt = "resources.lib.passlib.handlers.sha2_crypt",
    sun_md5_crypt = "resources.lib.passlib.handlers.sun_md5_crypt",
    unix_disabled = "resources.lib.passlib.handlers.misc",
    unix_fallback = "resources.lib.passlib.handlers.misc",
)
...
def register_crypt_handler_path(name, path):
    ...
    for a class named ``myhash`` within the ``myapp.helpers`` module::
        ...
        >>> from resources.lib.passlib.registry import registry_crypt_handler_path
