"""resources.lib.passlib.utils.compat - python 2/3 compatibility helpers"""
#=============================================================================
...
#=============================================================================
if PY26:
    _lazy_attrs['OrderedDict'] = 'resources.lib.passlib.utils.compat._ordered_dict.OrderedDict'
else:
...
class _LazyOverlayModule(ModuleType):
    ...
    used by :mod:`resources.lib.passlib.utils`, :mod:`resources.lib.passlib.crypto`,
    and :mod:`resources.lib.passlib.utils.compat`.
    """
