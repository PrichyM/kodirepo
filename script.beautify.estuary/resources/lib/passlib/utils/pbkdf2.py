"""resources.lib.passlib.pbkdf2 - PBKDF2 support
...
# site
# pkg
from resources.lib.passlib.exc import ExpectedTypeError
from resources.lib.passlib.utils.decor import deprecated_function
from resources.lib.passlib.utils.compat import native_string_types
from resources.lib.passlib.crypto.digest import norm_hash_name, lookup_hash, pbkdf1 as _pbkdf1, pbkdf2_hmac, compile_hmac
# local
__all__ = [
    # hash utils
    "norm_hash_name",
...
warn("the module 'resources.lib.passlib.utils.pbkdf2' is deprecated as of Passlib 1.7, "
     "and will be removed in Passlib 2.0, please use 'resources.lib.passlib.crypto' instead",
     DeprecationWarning)
...
norm_hash_name = deprecated_function(deprecated="1.7", removed="1.8", func_module=__name__,
    replacement="resources.lib.passlib.crypto.digest.norm_hash_name")(norm_hash_name)
...
def get_prf(name):
    ...
    Usage example::
        ...
        >>> from resources.lib.passlib.utils.pbkdf2 import get_prf
    ...
    .. deprecated:: 1.7
        ...
        This only related replacement is :func:`resources.lib.passlib.crypto.digest.compile_hmac`.
    """
    global _prf_cache
...
def pbkdf1(secret, salt, rounds, keylen=None, hash="sha1"):
    ...
    .. deprecated:: 1.7
        ...
        This has been relocated to :func:`resources.lib.passlib.crypto.digest.pbkdf1`,
...
def pbkdf2(secret, salt, rounds, keylen=None, prf="hmac-sha1"):
    ...
    .. deprecated:: 1.7
        ...
        This has been deprecated in favor of :func:`resources.lib.passlib.crypto.digest.pbkdf2_hmac`,
