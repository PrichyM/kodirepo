"""resources.lib.passlib.utils -- helpers for writing password hashes"""
#=============================================================================
# imports
#=============================================================================
from resources.lib.passlib.utils.compat import JYTHON
# core
...
from resources.lib.passlib.utils.decor import (
    # [remove these aliases in 2.0]
    deprecated_function,
    deprecated_method,
    memoized_property,
...
from resources.lib.passlib.exc import ExpectedStringError, ExpectedTypeError
from resources.lib.passlib.utils.compat import (add_doc, join_bytes, join_byte_values,
...
# XXX: should this be moved to resources.lib.passlib.crypto, or compat backports?
...
try:
    ...
    if threading and PYPY and (7, 2, 0) <= sys.pypy_version_info <= (7, 3, 3):
        ...
        from resources.lib.passlib.utils.compat import nullcontext
...
@deprecated_function(deprecated="1.7", removed="2.0",
                     replacement="resources.lib.passlib.pwd.genword() / resources.lib.passlib.pwd.genphrase()")
...
def is_crypt_context(obj):
    """check if object appears to be a :class:`~resources.lib.passlib.context.CryptContext` instance"""
