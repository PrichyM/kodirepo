"""resources.lib.passlib.apache - apache password support"""
# XXX: relocate this to resources.lib.passlib.ext.apache?
#=============================================================================
# imports
#=============================================================================
...
from resources.lib.passlib.exc import ExpectedStringError
from resources.lib.passlib.hash import htdigest
from resources.lib.passlib.utils import render_bytes, to_bytes, is_ascii_codec
from resources.lib.passlib.utils.decor import deprecated_method
from resources.lib.passlib.utils.compat import join_bytes, unicode, BytesIO, PY3
# local
__all__ = [
    'HtpasswdFile',
    'HtdigestFile',
...
class HtpasswdFile(_CommonFile):
    ...
    :type context: :class:`~resources.lib.passlib.context.CryptContext`
    :param context:
...
class HtdigestFile(_CommonFile):
    ...
    def get_hash(self, user, realm=None):
        """Return :class:`~resources.lib.passlib.hash.htdigest` hash stored for user.
