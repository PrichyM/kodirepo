"""resources.lib.passlib.ext.django.utils - helper functions used by this plugin"""
#=============================================================================
# imports
#=============================================================================
# core
...
try:
    ...
    DJANGO_VERSION = ()
# pkg
from resources.lib.passlib import exc, registry
from resources.lib.passlib.context import CryptContext
from resources.lib.passlib.exc import PasslibRuntimeWarning
from resources.lib.passlib.utils.compat import get_method_function, iteritems, OrderedDict, unicode
...
#: minimum version supported by resources.lib.passlib.ext.django
...
# map preset names -> resources.lib.passlib.app attrs
_preset_map = {
...
def get_preset_config(name):
    ...
    * ``"passlib-default"`` - default config used by this release of resources.lib.passlib.
    ...
    * ``"django-1.6"`` - config used by stock Django 1.6 installs
    ...
    import resources.lib.passlib.apps
    return getattr(resources.lib.passlib.apps, attr).to_string()
...
class DjangoTranslator(object):
    ...
    def _create_django_hasher(self, django_name):
        ...
        module = sys.modules.get("resources.lib.passlib.ext.django.models")
...
class DjangoContextAdapter(DjangoTranslator):
    ...
    When installed in django, :mod:`!resources.lib.passlib.ext.django` will create
    ...
    def __init__(self, context=None, get_user_category=None, **kwds):
        ...
        if make_password.__module__.startswith("resources.lib.passlib."):
    ...
    def install_patch(self):
        ...
        if DJANGO_VERSION < MIN_DJANGO_VERSION:
            raise RuntimeError("resources.lib.passlib.ext.django requires django >= %s" %
                               (MIN_DJANGO_VERSION,))
    ...
    def load_model(self):
        ...
        if self.enabled:
            ...
            self.remove_patch()
        log.debug("resources.lib.passlib.ext.django loaded")
...
class _PasslibHasherWrapper(object):
    """
    adapter which which wraps a :cls:`resources.lib.passlib.ifc.PasswordHash` class,
    and provides an interface compatible with the Django hasher API.

    :param passlib_handler:
        passlib hash handler (e.g. :cls:`resources.lib.passlib.hash.sha256_crypt`.
    """
    #=====================================================================
    # instance attrs
    #=====================================================================
...
##from resources.lib.passlib.utils import classproperty, to_native_str, to_unicode
