"""
resources.lib.passlib.tests -- tests for resources.lib.passlib.utils.pbkdf2

.. warning::

    This module & it's functions have been deprecated, and superceded
    by the functions in resources.lib.passlib.crypto.  This file is being maintained
...
# pkg
# module
from resources.lib.passlib.utils.compat import u, JYTHON
from resources.lib.passlib.tests.utils import TestCase, hb
...
class UtilsTest(TestCase):
    ...
    descriptionPrefix = "resources.lib.passlib.utils.pbkdf2"
    ...
    def setUp(self):
        ...
        warnings.filterwarnings("ignore", ".*resources.lib.passlib.utils.pbkdf2.*deprecated", DeprecationWarning)

    def test_norm_hash_name(self):
        """norm_hash_name()"""
        from itertools import chain
        from resources.lib.passlib.utils.pbkdf2 import norm_hash_name
        from resources.lib.passlib.crypto.digest import _known_hash_names
...
class Pbkdf1_Test(TestCase):
    """test kdf helpers"""
    descriptionPrefix = "resources.lib.passlib.utils.pbkdf2.pbkdf1()"
    ...
    def test_known(self):
        ...
        from resources.lib.passlib.utils.pbkdf2 import pbkdf1
...
class Pbkdf2_Test(TestCase):
    """test pbkdf2() support"""
    descriptionPrefix = "resources.lib.passlib.utils.pbkdf2.pbkdf2()"
    ...
    def test_known(self):
        """test reference vectors"""
        from resources.lib.passlib.utils.pbkdf2 import pbkdf2
