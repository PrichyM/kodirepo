"""
test resources.lib.passlib.ext.django against django source tests
"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from resources.lib.passlib.utils.compat import suppress_cause
from resources.lib.passlib.ext.django.utils import DJANGO_VERSION, DjangoTranslator, _PasslibHasherWrapper
# tests
from resources.lib.passlib.tests.utils import TestCase, TEST_MODE
    ...
    if source_path:
        ...
        if TEST_MODE("full"):
            ...
            sys.stderr.write("\nWARNING: $PASSLIB_TESTS_DJANGO_SOURCE_PATH is not set; "
                             "can't run Django's own unittests against resources.lib.passlib.ext.django\n")
...
if test_hashers_mod:
    ...
    class HashersTest(test_hashers_mod.TestUtilsHashPass, _ExtensionSupport):
        ...
        # port patchAttr() helper method from resources.lib.passlib.tests.utils.TestCase
        ...
        def setUp(self):
            #---------------------------------------------------------
            # install resources.lib.passlib.ext.django adapter, and get context
            #---------------------------------------------------------
            ...
            #---------------------------------------------------------
            from resources.lib.passlib.hash import django_des_crypt
