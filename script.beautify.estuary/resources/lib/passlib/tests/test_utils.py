"""tests for resources.lib.passlib.util"""
#=============================================================================
# imports
#=============================================================================
...
# pkg
# module
from resources.lib.passlib.utils import is_ascii_safe, to_bytes
from resources.lib.passlib.utils.compat import irange, PY2, PY3, u, unicode, join_bytes, PYPY
from resources.lib.passlib.tests.utils import TestCase, hb, run_with_fixed_seeds
...
class MiscTest(TestCase):
    ...
    def test_compat(self):
        ...
        from resources.lib.passlib.utils import compat
        # "<module 'resources.lib.passlib.utils.compat' from 'passlib/utils/compat.pyc'>"
        self.assertRegex(repr(compat),
                         r"^<module 'resources.lib.passlib.utils.compat' from '.*?'>$")
    ...
    def test_classproperty(self):
        from resources.lib.passlib.utils.decor import classproperty
    ...
    def test_deprecated_function(self):
        from resources.lib.passlib.utils.decor import deprecated_function
        ...
        with self.assertWarningList(dict(category=DeprecationWarning,
                message="the function resources.lib.passlib.tests.test_utils.test_func() "
    ...
    def test_memoized_property(self):
        from resources.lib.passlib.utils.decor import memoized_property
    ...
    def test_getrandbytes(self):
        """getrandbytes()"""
        from resources.lib.passlib.utils import getrandbytes
    ...
    def test_getrandstr(self, seed):
        """getrandstr()"""
        from resources.lib.passlib.utils import getrandstr
    ...
    def test_generate_password(self):
        """generate_password()"""
        from resources.lib.passlib.utils import generate_password
    ...
    def test_is_crypt_context(self):
        ...
        from resources.lib.passlib.utils import is_crypt_context
        from resources.lib.passlib.context import CryptContext
    ...
    def test_genseed(self):
        """test genseed()"""
        import random
        from resources.lib.passlib.utils import genseed
    ...
    def test_crypt(self):
        ...
        from resources.lib.passlib.utils import has_crypt, safe_crypt, test_crypt
        from resources.lib.passlib.registry import get_supported_os_crypt_schemes, get_crypt_handler
        ...
        import resources.lib.passlib.utils as mod
        orig = mod._crypt
        try:
            retval = None
    ...
    def test_consteq(self):
        ...
        from resources.lib.passlib.utils import consteq, str_consteq
    ...
    def test_saslprep(self):
        ...
        from resources.lib.passlib.utils import saslprep as sp
    ...
    def test_splitcomma(self):
        from resources.lib.passlib.utils import splitcomma
    ...
    def test_utf8_truncate(self):
        ...
        utf8_truncate()
        """
        from resources.lib.passlib.utils import utf8_truncate
...
class CodecTest(TestCase):
    """tests bytes/unicode helpers in resources.lib.passlib.utils"""
    ...
    def test_to_bytes(self):
        """test to_bytes()"""
        from resources.lib.passlib.utils import to_bytes
    ...
    def test_to_unicode(self):
        """test to_unicode()"""
        from resources.lib.passlib.utils import to_unicode
    ...
    def test_to_native_str(self):
        """test to_native_str()"""
        from resources.lib.passlib.utils import to_native_str
    ...
    def test_is_ascii_safe(self):
        """test is_ascii_safe()"""
        from resources.lib.passlib.utils import is_ascii_safe
    ...
    def test_is_same_codec(self):
        """test is_same_codec()"""
        from resources.lib.passlib.utils import is_same_codec
...
class Base64EngineTest(TestCase):
    ...
    def test_constructor(self):
        from resources.lib.passlib.utils.binary import Base64Engine, AB64_CHARS
    ...
    def test_ab64_decode(self):
        """ab64_decode()"""
        from resources.lib.passlib.utils.binary import ab64_decode
    ...
    def test_ab64_encode(self):
        """ab64_encode()"""
        from resources.lib.passlib.utils.binary import ab64_encode
    ...
    def test_b64s_decode(self):
        """b64s_decode()"""
        from resources.lib.passlib.utils.binary import b64s_decode
    ...
    def test_b64s_encode(self):
        """b64s_encode()"""
        from resources.lib.passlib.utils.binary import b64s_encode
...
class _Base64Test(TestCase):
    ...
    def test_codec(self):
        ...
        engine = self.engine
        from resources.lib.passlib.utils import getrandbytes, getrandstr
        rng = self.getRandom()
        saw_zero = False
        for i in irange(500):
            #
...
from resources.lib.passlib.utils.binary import h64, h64big
