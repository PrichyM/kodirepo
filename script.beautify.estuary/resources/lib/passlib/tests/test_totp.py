"""resources.lib.passlib.tests -- test resources.lib.passlib.totp"""
#=============================================================================
# imports
#=============================================================================
# core
...
from resources.lib.passlib.utils.compat import unicode, u
from resources.lib.passlib.tests.utils import TestCase, time_call
# subject
from resources.lib.passlib import totp as totp_module
from resources.lib.passlib.totp import TOTP, AppWallet, AES_SUPPORT
# local
__all__ = [
    "EngineTest",
]
...
class AppWalletTest(TestCase):
    descriptionPrefix = "resources.lib.passlib.totp.AppWallet"
...
class TotpTest(TestCase):
    ...
    descriptionPrefix = "resources.lib.passlib.totp.TOTP"
    ...
    def test_totp_token(self):
        ...
        from resources.lib.passlib.totp import TOTP, TotpToken
    ...
    def assertTotpMatch(self, match, time, skipped=0, period=30, window=30, msg=''):
        from resources.lib.passlib.totp import TotpMatch
