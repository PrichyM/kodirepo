"""test resources.lib.passlib.ext.django"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from resources.lib.passlib import apps as _apps, exc, registry
from resources.lib.passlib.apps import django10_context, django14_context, django16_context
from resources.lib.passlib.context import CryptContext
from resources.lib.passlib.ext.django.utils import (
    DJANGO_VERSION, MIN_DJANGO_VERSION, DjangoTranslator, quirks,
)
from resources.lib.passlib.utils.compat import iteritems, get_method_function, u
from resources.lib.passlib.utils.decor import memoized_property
# tests
from resources.lib.passlib.tests.utils import TestCase, TEST_MODE, handler_derived_from
from resources.lib.passlib.tests.test_handlers import get_handler_case
# local
__all__ = [
    "DjangoBehaviorTest",
...
def _modify_django_config(kwds, sha_rounds=None):
    ...
    # update defaults
    kwds.update(
        # TODO: push this to resources.lib.passlib.apps django contexts
        deprecated="auto",
    )
...
#      or maybe add a "get_django_context(django_version)" helper to resources.lib.passlib.apps?
...
#----------------------------------------------------
from resources.lib.passlib.hash import django_pbkdf2_sha256
sample_hashes = dict(
...
class _ExtensionSupport(object):
    ...
    def assert_unpatched(self):
        ...
        mod = sys.modules.get("resources.lib.passlib.ext.django.models")
        ...
        for obj, attr, source, patched in self._iter_patch_candidates():
            if patched:
                ...
                self.assertFalse(source.startswith("resources.lib.passlib."),
    ...
    def assert_patched(self, context=None):
        ...
        for obj, attr, source, patched in self._iter_patch_candidates():
            if patched:
                self.assertTrue(source == "resources.lib.passlib.ext.django.utils",
    ...
    def load_extension(self, check=True, **kwds):
        ...
        import resources.lib.passlib.ext.django.models
        if check:
    ...
    def unload_extension(self):
        ...
        if mod:
            ...
            del sys.modules["resources.lib.passlib.ext.django.models"]
...
class DjangoBehaviorTest(_ExtensionTest):
    ...
    running the ExtensionBehaviorTest subclass below verifies "resources.lib.passlib.ext.django"
    ...
    #: tracks whether tests should assume "resources.lib.passlib.ext.django" monkeypatch is applied.
    ...
    def test_extension_config(self):
        ...
        from resources.lib.passlib.ext.django.models import password_context
...
class ExtensionBehaviorTest(DjangoBehaviorTest):
    """
    test that "resources.lib.passlib.ext.django" conforms to behavioral assertions in DjangoBehaviorTest
    """
...
class DjangoExtensionTest(_ExtensionTest):
    """
    test the ``resources.lib.passlib.ext.django`` plugin
    """
    #===================================================================
    # class attrs
    #===================================================================

    descriptionPrefix = "resources.lib.passlib.ext.django plugin"
    ...
    def test_01_overwrite_detection(self):
        ...
        from resources.lib.passlib.ext.django.models import adapter
        def dummy():
            pass
    ...
    def test_02_handler_wrapper(self):
        ...
        from resources.lib.passlib.hash import sha256_crypt
    ...
    def test_13_config_defaults(self):
        ...
        from resources.lib.passlib.ext.django.utils import PASSLIB_DEFAULT
    ...
    def test_14_config_invalid(self):
        ...
        self.assertRaises(TypeError, __import__, 'resources.lib.passlib.ext.django.models')

        self.unload_extension()
        update_settings(PASSLIB_CONFIG="missing-preset", PASSLIB_CONTEXT=UNSET)
        self.assertRaises(ValueError, __import__, 'resources.lib.passlib.ext.django.models')
