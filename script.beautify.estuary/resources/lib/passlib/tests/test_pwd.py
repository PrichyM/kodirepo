"""resources.lib.passlib.tests -- tests for resources.lib.passlib.pwd"""
#=============================================================================
# imports
#=============================================================================
# core
...
class UtilsTest(TestCase):
    ...
    descriptionPrefix = "resources.lib.passlib.pwd"

    def test_self_info_rate(self):
        """_self_info_rate()"""
        from resources.lib.passlib.pwd import _self_info_rate
    ...
    #     """_total_self_info()"""
    #     from resources.lib.passlib.pwd import _total_self_info
    #
...
# import subject
from resources.lib.passlib.pwd import genphrase
simple_words = ["alpha", "beta", "gamma"]

class PhraseGeneratorTest(TestCase):
    """test generation routines"""
    descriptionPrefix = "resources.lib.passlib.pwd.genphrase()"
