"""tests for resources.lib.passlib.hash -- (c) Assurance Technologies 2003-2009"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from resources.lib.passlib import hash, registry, exc
from resources.lib.passlib.registry import register_crypt_handler, register_crypt_handler_path, \
...
from resources.lib.passlib.tests.utils import TestCase
# module
...
class RegistryTest(TestCase):
    ...
    descriptionPrefix = "resources.lib.passlib.registry"
    ...
    def test_hash_proxy(self):
        """test resources.lib.passlib.hash proxy object"""
        # check dir works
        dir(hash)
    ...
    def test_register_crypt_handler_path(self):
        ...
        sys.modules.pop("resources.lib.passlib.tests._test_bad_register", None)
        register_crypt_handler_path("dummy_bad", "resources.lib.passlib.tests._test_bad_register")
        with warnings.catch_warnings():
            warnings.filterwarnings("ignore", "xxxxxxxxxx", DeprecationWarning)
            h = get_crypt_handler("dummy_bad")
        from resources.lib.passlib.tests import _test_bad_register as tbr
    ...
    def test_list_crypt_handlers(self):
        ...
        from resources.lib.passlib.registry import list_crypt_handlers
    ...
    def test_handlers(self):
        ...
        from resources.lib.passlib.registry import list_crypt_handlers
        from resources.lib.passlib.tests.test_handlers import get_handler_case, conditionally_available_hashes
        for name in list_crypt_handlers():
