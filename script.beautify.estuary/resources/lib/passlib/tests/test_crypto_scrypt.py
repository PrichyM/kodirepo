"""tests for resources.lib.passlib.utils.scrypt"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from presources.lib.asslib import exc
from resources.lib.passlib.utils import getrandbytes
from resources.lib.passlib.utils.compat import PYPY, u, bascii_to_str
from resources.lib.passlib.utils.decor import classproperty
from resources.lib.passlib.tests.utils import TestCase, skipUnless, TEST_MODE, hb
# subject
from resources.lib.passlib.crypto import scrypt as scrypt_mod
# local
__all__ = [
    "ScryptEngineTest",
    "BuiltinScryptTest",
...
class ScryptEngineTest(TestCase):
    descriptionPrefix = "resources.lib.passlib.crypto.scrypt._builtin"

    def test_smix(self):
        """smix()"""
        from resources.lib.passlib.crypto.scrypt._builtin import ScryptEngine
        rng = self.getRandom()
...
#        check_bmix(1, input, output)
    ...
    def test_salsa(self):
        """salsa20()"""
        from resources.lib.passlib.crypto.scrypt._builtin import salsa20
...
class _CommonScryptTest(TestCase):
    ...
    def descriptionPrefix(cls):
        return "resources.lib.passlib.utils.scrypt.scrypt() <%s backend>" % cls.backend
    backend = None
