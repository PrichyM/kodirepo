"""tests for resources.lib.passlib.win32 -- (c) Assurance Technologies 2003-2009"""
#=============================================================================
# imports
#=============================================================================
# core
...
class UtilTest(TestCase):
    """test util funcs in resources.lib.passlib.win32"""
    ...
    def setUp(self):
        ...
        warnings.filterwarnings("ignore",
                                "the 'resources.lib.passlib.win32' module is deprecated")

    def test_lmhash(self):
        from resources.lib.passlib.win32 import raw_lmhash
        for secret, hash in [
    ...
    def test_nthash(self):
        ...
        from resources.lib.passlib.win32 import raw_nthash
        for secret, hash in [
