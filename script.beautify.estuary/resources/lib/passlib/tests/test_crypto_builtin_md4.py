"""resources.lib.passlib.tests -- unittests for resources.lib.passlib.crypto._md4"""
#=============================================================================
# imports
#=============================================================================
...
# pkg
# module
from resources.lib.passlib.utils.compat import bascii_to_str, PY3, u
from resources.lib.passlib.crypto.digest import lookup_hash
from resources.lib.passlib.tests.utils import TestCase, skipUnless
# local
__all__ = [
    "_Common_MD4_Test",
    "MD4_Builtin_Test",
...
class MD4_Builtin_Test(_Common_MD4_Test):
    descriptionPrefix = "resources.lib.passlib.crypto._md4.md4()"
    ...
    def setUp(self):
        ...
        # make sure we're using right constructor.
        self.assertEqual(self.get_md4_const().__module__, "resources.lib.passlib.crypto._md4")
