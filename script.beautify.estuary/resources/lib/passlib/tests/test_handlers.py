...
# site
# pkg
from resources.lib.passlib import exc, hash
from resources.lib.passlib.utils import repeat_string
from resources.lib.passlib.utils.compat import irange, PY3, u, get_method_function
from resources.lib.passlib.tests.utils import TestCase, HandlerCase, skipUnless, \
...
def get_handler_case(scheme):
    ...
    for module in _handler_test_modules:
        modname = "resources.lib.passlib.tests." + module
        __import__(modname)
...
class hex_md5_test(HandlerCase):
    ...
    def test_mock_fips_mode(self):
        ...
        from resources.lib.passlib.handlers.digests import create_hex_hash
...
class lmhash_test(EncodingHandlerMixin, HandlerCase):
    ...
    def test_90_raw(self):
        ...
        from resources.lib.passlib.utils.compat import str_to_bascii
        lmhash = self.handler
