"""resources.lib.passlib.tests.test_handlers_django - tests for passlib hash algorithms"""
#=============================================================================
# imports
#=============================================================================
...
from resources.lib.passlib.utils.compat import u
from resources.lib.passlib.tests.utils import TestCase, HandlerCase, skipUnless, SkipTest
from resources.lib.passlib.tests.test_handlers import UPASS_USD, UPASS_TABLE
from resources.lib.passlib.tests.test_ext_django import DJANGO_VERSION, MIN_DJANGO_VERSION, \
...
from resources.lib.passlib.tests.test_handlers_argon2 import _base_argon2_test
