"""resources.lib.passlib.tests.test_handlers - tests for passlib hash algorithms"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from resources.lib.passlib import hash
from resources.lib.passlib.handlers.bcrypt import IDENT_2, IDENT_2X
from resources.lib.passlib.utils import repeat_string, to_bytes, is_safe_crypt_input
from resources.lib.passlib.utils.compat import irange, PY3
from resources.lib.passlib.tests.utils import HandlerCase, TEST_MODE
from resources.lib.passlib.tests.test_handlers import UPASS_TABLE
# module
...
class _bcrypt_test(HandlerCase):
    ...
    def crypt_supports_variant(self, hash):
        ...
        from resources.lib.passlib.handlers.bcrypt import bcrypt, IDENT_2X, IDENT_2Y
        from resources.lib.passlib.utils import safe_crypt
    ...
    def fuzz_verifier_bcrypt(self):
        ...
        from resources.lib.passlib.handlers.bcrypt import IDENT_2, IDENT_2A, IDENT_2B, IDENT_2X, IDENT_2Y, _detect_pybcrypt
        from resources.lib.passlib.utils import to_native_str, to_bytes
        try:
            import bcrypt
        except ImportError:
            return
    ...
    def fuzz_verifier_pybcrypt(self):
        ...
        from resources.lib.passlib.handlers.bcrypt import (
        ...
        from resources.lib.passlib.handlers.bcrypt import _pybcrypt as bcrypt_mod
    ...
    def fuzz_verifier_bcryptor(self):
        ...
        from resources.lib.passlib.handlers.bcrypt import IDENT_2, IDENT_2A, IDENT_2Y, IDENT_2B
        from resources.lib.passlib.utils import to_native_str
        try:
...
class _bcrypt_sha256_test(HandlerCase):
    ...
    def test_calc_digest_v2(self):
        ...
        """
        from resources.lib.passlib.hash import bcrypt
        from resources.lib.passlib.crypto.digest import compile_hmac
        from resources.lib.passlib.utils.binary import b64encode
