"""tests for resources.lib.passlib.utils.(des|pbkdf2|md4)"""
#=============================================================================
# imports
#=============================================================================
...
# pkg
# module
from resources.lib.passlib.exc import UnknownHashError
from resources.lib.passlib.utils.compat import PY3, u, JYTHON
from resources.lib.passlib.tests.utils import TestCase, TEST_MODE, skipUnless, hb
...
class HashInfoTest(TestCase):
    ...
    descriptionPrefix = "resources.lib.passlib.crypto.digest"
    ...
    def test_norm_hash_name(self):
        ...
        from resources.lib.passlib.crypto.digest import norm_hash_name, _known_hash_names
    ...
    def test_mock_fips_mode(self):
        ...
        """
        from resources.lib.passlib.crypto.digest import lookup_hash, _set_mock_fips_mode
...
class Pbkdf1_Test(TestCase):
    """test kdf helpers"""
    descriptionPrefix = "resources.lib.passlib.crypto.digest.pbkdf1"
    ...
    def test_known(self):
        ...
        from resources.lib.passlib.crypto.digest import pbkdf1
...
from resources.lib.passlib.crypto.digest import pbkdf2_hmac, PBKDF2_BACKENDS

# NOTE: relying on tox to verify this works under all the various backends.
class Pbkdf2Test(TestCase):
    """test pbkdf2() support"""
    descriptionPrefix = "resources.lib.passlib.crypto.digest.pbkdf2_hmac() <backends: %s>" % ", ".join(PBKDF2_BACKENDS)
    ...
    def test_backends(self):
        ...
        from resources.lib.passlib.crypto.digest import PBKDF2_BACKENDS
