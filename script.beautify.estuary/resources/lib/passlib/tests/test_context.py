"""tests for resources.lib.passlib.context"""
#=============================================================================
# imports
#=============================================================================
# core
...
from resources.lib.passlib.context import CryptContext, LazyCryptContext
from resources.lib.passlib.exc import PasslibConfigWarning, PasslibHashWarning
from resources.lib.passlib.utils import tick, to_unicode
from resources.lib.passlib.utils.compat import irange, u, unicode, str_to_uascii, PY2, PY26
import resources.lib.passlib.utils.handlers as uh
from resources.lib.passlib.tests.utils import (TestCase, set_file, TICK_RESOLUTION,
                                 quicksleep, time_call, handler_derived_from)
from resources.lib.passlib.registry import (register_crypt_handler_path,
...
##        self.assertEqual(getdep(cc), ["md5_crypt"])
    ...
    def test_35_to_string(self):
        ...
        from resources.lib.passlib.tests.test_utils_handlers import UnsaltedHash
    ...
    def test_48_context_kwds(self):
        ...
        from resources.lib.passlib.hash import des_crypt, md5_crypt, postgres_md5
    ...
    def test_disabled_hashes(self):
        ...
        from resources.lib.passlib.hash import md5_crypt, unix_disabled
...
class LazyCryptContextTest(TestCase):
    ...
    def test_kwd_constructor(self):
        ...
        register_crypt_handler_path("dummy_2", "resources.lib.passlib.tests.test_context")
