...
from resources.lib.passlib.context import CryptContext, CryptPolicy, LazyCryptContext
from resources.lib.passlib.utils import to_bytes, to_unicode
import resources.lib.passlib.utils.handlers as uh
from resources.lib.passlib.tests.utils import TestCase, set_file
...
"""
    ...
    if not os.path.exists(sample_config_1s_path) and resource_filename:
        ...
        sample_config_1s_path = resource_filename("resources.lib.passlib.tests",
