"""resources.lib.passlib.ifc - abstract interfaces used by Passlib"""
#=============================================================================
# imports
#=============================================================================
# core
...
class PasswordHash(object):
    ...
    #: If True, .hash() should throw a :exc:`~resources.lib.passlib.exc.PasswordSizeError` for
    ...
    #: also indicates to resources.lib.passlib.ext.django that (when installed in django),
