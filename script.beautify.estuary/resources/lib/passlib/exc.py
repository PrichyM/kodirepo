"""resources.lib.passlib.exc -- exceptions & warnings raised by passlib"""
#=============================================================================
# exceptions
#=============================================================================
...
class MissingBackendError(RuntimeError):
    ...
    :class:`~resources.lib.passlib.hash.bcrypt`).
    """
...
class PasswordTruncateError(PasswordSizeError):
    ...
    Hashers such as :class:`~resources.lib.passlib.hash.bcrypt` can be configured to raises
...
class TokenError(ValueError):
    """
    Base error raised by v:mod:`resources.lib.passlib.totp` when
...
class MalformedTokenError(TokenError):
    """
    Error raised by :mod:`resources.lib.passlib.totp` when a token isn't formatted correctly
...
class InvalidTokenError(TokenError):
    """
    Error raised by :mod:`resources.lib.passlib.totp` when a token is formatted correctly,
...
class UsedTokenError(TokenError):
    """
    Error raised by :mod:`resources.lib.passlib.totp` if a token is reused.
...
class UnknownHashError(ValueError):
    """
    Error raised by :class:`~resources.lib.passlib.crypto.lookup_hash` if hash name is not recognized.
    ...
    As of version 1.7.4, this may be raised if a :class:`~resources.lib.passlib.context.CryptContext`
...
class PasslibConfigWarning(PasslibWarning):
    ...
    of a :class:`~resources.lib.passlib.context.CryptContext` instance.
