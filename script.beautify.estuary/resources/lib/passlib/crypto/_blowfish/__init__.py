"""resources.lib.passlib.crypto._blowfish - pure-python eks-blowfish implementation for bcrypt
...
import struct
# pkg
from resources.lib.passlib.utils import getrandbytes, rng
from resources.lib.passlib.utils.binary import bcrypt64
from resources.lib.passlib.utils.compat import BytesIO, unicode, u, native_string_types
from resources.lib.passlib.crypto._blowfish.unrolled import BlowfishEngine
# local
__all__ = [
    'BlowfishEngine',
    'raw_bcrypt',
...
# base bcrypt helper
#
# interface designed only for use by resources.lib.passlib.handlers.bcrypt:BCrypt
