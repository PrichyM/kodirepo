"""
resources.lib.passlib.crypto._md4 -- fallback implementation of MD4
...
.. note::
    ...
    by ``resources.lib.passlib.crypto.lookup_hash()`` when a native implementation can't be found.
"""
...
import struct
# site
from resources.lib.passlib.utils.compat import bascii_to_str, irange, PY3
# local
__all__ = ["md4"]
