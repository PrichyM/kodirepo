"""
resources.lib.passlib.utils.scrypt -- scrypt hash frontend and help utilities
...
from resources.lib.passlib.utils.compat import PYPY
# local
__all__ =[
    "validate",
    "scrypt",
...
def _load_builtin_backend():
    """
    Load pure-python scrypt implementation built into resources.lib.passlib.
    """
...
def _set_backend(name, dryrun=False):
    ...
    :raises ~resources.lib.passlib.exc.MissingBackendError: if backend can't be found
