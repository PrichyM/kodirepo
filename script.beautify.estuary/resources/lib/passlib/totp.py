"""resources.lib.passlib.totp -- TOTP / RFC6238 / Google Authenticator utilities."""
#=============================================================================
# imports
#=============================================================================
from __future__ import absolute_import, division, print_function
from resources.lib.passlib.utils.compat import PY3
# core
import base64
import calendar
import json
...
from resources.lib.passlib.exc import TokenError, MalformedTokenError, InvalidTokenError, UsedTokenError
from resources.lib.passlib.utils import (to_unicode, to_bytes, consteq,
                           getrandbytes, rng, SequenceMixin, xor_bytes, getrandstr)
from resources.lib.passlib.utils.binary import BASE64_CHARS, b32encode, b32decode
from resources.lib.passlib.utils.compat import (u, unicode, native_string_types, bascii_to_str, int_types, num_types,
                                  irange, byte_elem_value, UnicodeIO, suppress_cause)
from resources.lib.passlib.utils.decor import hybrid_method, memoized_property
from resources.lib.passlib.crypto.digest import lookup_hash, compile_hmac, pbkdf2_hmac
from resources.lib.passlib.hash import pbkdf2_sha256
# local
__all__ = [
    # frontend classes
    "AppWallet",
    ...
    # errors (defined in resources.lib.passlib.exc, but exposed here for convenience)
    "TokenError",
        "MalformedTokenError",
        "InvalidTokenError",
        "UsedTokenError",
...
class TOTP(object):
    ...
    #: minimum number of bytes to allow in key, enforced by resources.lib.passlib.
    ...
    def using(cls, digits=None, alg=None, period=None,
        ...
        As an example::
            ...
            >>> from resources.lib.passlib.totp import TOTP, generate_secret
...
#            counter += 1
    ...
    def verify(cls, token, source, **kwds):
        ...
        It's designed to parallel the :meth:`resources.lib.passlib.ifc.PasswordHash.verify` method.
    ...
    def match(self, token, time=None, window=30, skew=0, last_counter=None):
        ...
        :raises ~resources.lib.passlib.exc.TokenError:
    ...
    def to_uri(self, label=None, issuer=None):
        ...
        Usage example::
            ...
            >>> from resources.lib.passlib.totp import TOTP
